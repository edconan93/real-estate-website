									...
									<table cellspacing="0" cellpadding="0" border="0" align="center" width="700">
										<tbody>
											<tr>
												...
												<br>
													<h1>Liên hệ realestate_hoaphuong.com</h1>
													<br>
													<form method="POST" action="http://www.nhaban.com/contact/index.php">
														...
														<tbody>
															...
															<tr>
																...
																<td align="left">
																<input type="text" maxlength="30" value="" name="name" size="45">
																</td>
															</tr>
															<tr>
																<td>
																...
																<td align="left">
																<input type="text" maxlength="30" value="" name="phone" size="45">
																</td>
															</tr>
															<tr>
																<td>
																...
																<td align="left">
																<input type="text" maxlength="30" value="" name="e_mail" size="45">
																</td>
															</tr>
															<tr>
																<td>
																...
																<td align="left">
																<input type="text" maxlength="30" value="" name="address" size="45">
																</td>
															</tr>
															<tr>
																<td>
