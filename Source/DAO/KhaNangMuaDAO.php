...
<?php
	class KhaNangMuaDAO
	{
        ...
        {
            $strSQL = "Insert into khanangmua values (NULL,'$ten', $status)";
    	...
    	public static function Update ($id, $ten, $status)
        {
            ...
            $strSQL = "update khanangmua set ten='$ten', status=$status
					   where id=$id";
		    $cn = DataProvider::Open ();
			DataProvider::MoreQuery ($strSQL,$cn);
        ...
        {
            $strSQL = "update khanangmua set status= '$status' where user_id=$user_id";
            $cn = DataProvider::Open ();
			DataProvider::MoreQuery ($strSQL,$cn);
