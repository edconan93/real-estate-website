...
<?php
	class ChiTietGiaoDichMuaDAO
	{
    	public static function Add ($khachhang, $giamuatu, $giamuaden, $donvi , $ngay ,$tieuchi, $khachhangmua, $status)
        {
            $strSQL = "Insert into chitietgiaodichmua values (NULL,'$khachhang', '$giamuatu', '$giamuaden', '$donvi', '$ngay','$tieuchi','$khachhangmua', '$status')";
    	...
    	public static function Update ($id, $khachhang, $giamuatu, $giamuaden, $donvi , $ngay ,$tieuchi, $khachhangmua, $status)
        {

            $strSQL = "update chitietgiaodichmua set khachhang='$khachhang',giamuatu='$giamuatu',giamuaden='$giamuaden',
						donvi='$donvi',ngay='$ngay', tieuchi='$tieuchi',
			 			khachhangmua='$khachhangmua', status= '$status'
						where id=$id";
		    $cn = DataProvider::Open ();
			DataProvider::MoreQuery ($strSQL,$cn);
        ...
        {
            $strSQL = "update users set status= '$status' where id=$id";
            $cn = DataProvider::Open ();
			DataProvider::MoreQuery ($strSQL,$cn);
