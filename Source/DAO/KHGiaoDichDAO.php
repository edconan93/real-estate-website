...
<?php
	class KHGiaoDichDAO
	{
    	public static function Add ($hoten, $email, $gioitinh,$sdt1,$sodt2, $loaikh, $status)
        {
            $strSQL = "Insert into khgiaodich values (NULL, '$hoten', '$email', '$gioitinh', '$sdt1','$sdt2','$loaikh','$status')";
    	...
    	public static function Update ($id, $hoten, $email, $gioitinh,$sdt1,$sodt2, $loaikh, $status)
        {

            $strSQL = "update khgiaodich set hoten='$hoten',email='$email',gioitinh='$gioitinh',
						sdt1='$sdt1',sodt2='$sodt2', answer='$answer',
			 			loaikh='$loaikh', status= '$status' where id=$id";
		    $cn = DataProvider::Open ();
			DataProvider::MoreQuery ($strSQL,$cn);
		...
		// public static function SetPassword ($user_id, $newPassword)
        // {
            // $strSQL = "update users set password= '$newPassword' where user_id=$user_id";
            // $cn = DataProvider::Open ();
			// DataProvider::MoreQuery ($strSQL,$cn);
        ...
        {
            $strSQL = "update users set email= '$Email' where id=$id";
            $cn = DataProvider::Open ();
			DataProvider::MoreQuery ($strSQL,$cn);
        ...
        // {
            // $strSQL = "update users set avatar= '$avatar' where user_id=$user_id";
            // $cn = DataProvider::Open ();
			// DataProvider::MoreQuery ($strSQL,$cn);
        ...
        {
            $strSQL = "select * from khgiaodich where username='$username' and password='$password' and status=1";
		...
		public static function GetKHGiaoDichByID ($id)
		{
