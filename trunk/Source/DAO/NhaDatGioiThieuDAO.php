...
<?php
	class NhaDatGioiThieuDAO
	{
    	public static function Add ($idgiaodichmua, $idthongtinnhadat, $status)
        {
            $strSQL = "Insert into nhadatgioithieu values (NULL,'$idgiaodichmua', '$idthongtinnhadat', '$status')";
    	...
    	public static function Update ($id, $idgiaodichmua, $idthongtinnhadat, $status)
        {

            $strSQL = "update nhadatgioithieu set idgiaodichmua='$idgiaodichmua',idthongtinnhadat='$idthongtinnhadat', status= '$status'
						where id=$id";
		    $cn = DataProvider::Open ();
			DataProvider::MoreQuery ($strSQL,$cn);
        ...
        {
            $strSQL = "update nhadatgioithieu set status= '$status' where id=$id";
            $cn = DataProvider::Open ();
			DataProvider::MoreQuery ($strSQL,$cn);
